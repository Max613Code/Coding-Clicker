...
//            if (SO.generatorName != "")
//            {
//                upgClass = new UpgradeClass(SO.upgradeName, SO.upgradeDescription, (decimal)SO.cost, SO.multiplier, SO.dropDown.ToString(), GameObject.Find(SO.generatorName).GetComponent<GeneratorMaker>(), SO.GeneratorImage);
//            }
//            else
//            {
//                upgClass = new UpgradeClass(SO.upgradeName, SO.upgradeDescription, (decimal)SO.cost, SO.multiplier, SO.dropDown.ToString(), null, SO.GeneratorImage);
//            }
